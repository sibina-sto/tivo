...
function App() {
  return (
    <div>
      ...
      >
        <defs>
          <style dangerouslySetInnerHTML={{ __html: ".cls-1{fill:#5f4def;}" }} />
        </defs>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <div className="text-container">
                        ...
                        <p>
                          It's very easy to start using Tivo. You just need to fill
                          out and submit the{" "}
                      ...
                      <div className="text-container">
                        ...
                        <ul className="list-unstyled li-space-lg">
                          <li className="media">
                            <i className="fas fa-square" />
                            <div className="media-body">
                              If you set it up correctly you will get acces to great
                              intel
                            </div>
                          </li>
                          <li className="media">
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <div className="p-heading">
                What better way to show off Tivo marketing automation saas app than
                presenting you some great situations of each module and tool
                ...
                <div className="swiper-container text-slider">
                  <div className="swiper-wrapper">
                    ...
                    <div className="swiper-slide">
                      ...
                      <div className="text-wrapper">
                        <div className="testimonial-text">
                          I started to use Tivo with the free trial about a year ago
                          and never stopped since then. It does all the repeating
                          marketing tasks and allows me to focus on core development
                          activities like new product research and design. I love it
                    ...
                    <div className="swiper-slide">
                      ...
                      <div className="text-wrapper">
                        <div className="testimonial-text">
                          ...
                          ammount of money would bring me so many leads per month.
                          Before Tivo I used the services of an agency which cost
                          10x more and delivered far less. Highly recommended to
                    ...
                    <div className="swiper-slide">
                      ...
                      <div className="text-wrapper">
                        <div className="testimonial-text">
                          ...
                          medium sized business. It understands the mindset of young
                          entrepreneurs and provides the necessary data for wise
                          marketing decisions. Just give it a try and you will
                    ...
                    <div className="swiper-slide">
                      ...
                      <div className="text-wrapper">
                        <div className="testimonial-text">
                          Tivo is one of the greatest marketing automation apps out
                          there. I especially love the Reporting Tools module
      ...
      >
        <defs>
          <style dangerouslySetInnerHTML={{ __html: ".cls-2{fill:#5f4def;}" }} />
        </defs>
